...
public class UpdateQueryOperator {
	...
	public void addAccount(String AccountName, Date AccountStartDate, int balance) throws SQLException {
		Account a = new Account(AccountName, AccountStartDate, balance);
		accountDao.update(a);
	}
